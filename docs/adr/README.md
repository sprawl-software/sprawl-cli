...
- **ADR 004:** Establishes the non-destructive local rules drift isolation logic.
- **ADR 005:** Establishes the centralized exception flow and bans direct `sys.exit` calls in command handlers.

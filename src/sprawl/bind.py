...
Your behavior and knowledge base for this workspace are defined in the `.agents/` directory.

**MANDATORY INSTRUCTIONS:**
1. Before taking any action, you MUST read `.agents/AGENTS.md`.
...
Follow the conventions and protocols defined in `.agents/` without deviation.
"""
